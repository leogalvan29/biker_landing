...
class ParagonIE_Sodium_File extends ParagonIE_Sodium_Core_Util
{
    ...
    public static function verify($sig, $filePath, $publicKey)
    {
        ...
        if (
            (ParagonIE_Sodium_Core_Ed25519::chrToInt($sig[63]) & 240)
                &&
            ParagonIE_Sodium_Core_Ed25519::checkbiker_landing_lt_L(self::substr($sig, 32, 32))
        ) {
    ...
    {
        /* Security checks */
        if (ParagonIE_Sodium_Core32_Ed25519::checkbiker_landing_lt_L(self::substr($sig, 32, 32))) {
            throw new SodiumException('S < L - Invalid signature');
        }
