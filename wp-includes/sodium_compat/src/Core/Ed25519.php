...
abstract class ParagonIE_Sodium_Core_Ed25519 extends ParagonIE_Sodium_Core_Curve25519
{
    ...
    public static function verify_detached($sig, $message, $pk)
    {
        ...
        if ((self::chrToInt($sig[63]) & 240) && self::checkbiker_landing_lt_L(self::substr($sig, 32, 32))) {
     ...
     * @throws TypeError
     */
    public static function checkbiker_landing_lt_L($S)
    {
        if (self::strlen($S) < 32) {
    ...
    public static function scalar_random()
    {
        do {
            ...
            !self::checkbiker_landing_lt_L($r) || ParagonIE_Sodium_Compat::is_zero($r)
        );
        return $r;
    }
